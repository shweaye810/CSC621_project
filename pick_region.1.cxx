...
/*
    team_wind::typedef itk::ConfidenceConnectedImageFilter<ImageType, ImageType> ConfidenceConnectedFilterType;
    team_wind::ConfidenceConnectedFilterType::Pointer confidenceConnectedFilter = ConfidenceConnectedFilterType::New();
    ...
    team_wind:://confidenceConnectedFilter->SetReplaceValue(50);
    ...
    typedef itk::ScalarToRGBColormapImageFilter<ImageType, RGBImageType> RGBFilterType;
    RGBFilterType::Pointer rgb_filter = RGBFilterType::New();
    team_wind::rgb_filter->SetInput(confidenceConnectedFilter->GetOutput());
